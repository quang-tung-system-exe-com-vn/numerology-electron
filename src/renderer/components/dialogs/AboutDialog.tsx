          ...
          <table className="text-sm w-full max-w-md">
            <tbody>
              ...
              <tr className="h-[25px]">
                ...
                <td>
                  <a href="https://github.com/quang-tung-system-exe-com-vn/numerology-electron" className="text-blue-600 hover:underline" target="_blank" rel="noreferrer">
                    https://github.com/quang-tung-system-exe-com-vn/numerology-electron
                  </a>
                </td>
              </tr>
              <tr className="h-[25px]">
