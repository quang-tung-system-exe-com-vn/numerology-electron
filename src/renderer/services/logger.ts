...
const customColors = {
  info: { background: '#1e3d8f', text: '#fff' },
  success: { background: '#2d6a4f', text: '#fff' },
  warning: { background: '#d47a14', text: '#fff' },
  error: { background: '#d94c4c', text: '#fff' },
  debug: { background: '#7a2a8c', text: '#fff' },
}
class Logger {
